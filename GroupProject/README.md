# Group Project — Hospital Readmission Prediction

STAT3612 group project: predict 30-day hospital readmission risk using ensemble methods.

## Team

Joint work by (in alphabetical order):
